...
const int startDay = 4; // day for start sampling
const int startHour = 18; // hour for start sampling on 24-hr format
const int startMinute = 15; // minute for start sampling
